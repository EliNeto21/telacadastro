...
namespace telacadastro
{
    public partial class Form1 : Form
    {
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            if (txtNome.Text == "")
            {
                MessageBox.Show("É preciso preencher o campo nome.");
                txtNome.Focus();
                return;
            }
            ...
            if (txtData.Text == "")
            {
                MessageBox.Show("É preciso informar a data de nascimento.");
                txtData.Focus();
                return;
            }
            ...
            if (txtTelefone.Text == "(  )      -")
            {
                MessageBox.Show("É preciso preencher o campo telefone.");
                txtTelefone.Focus();
                return;
            }
